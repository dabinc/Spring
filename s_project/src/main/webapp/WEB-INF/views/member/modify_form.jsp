...
<body>
	...
	<div style="width:500px; margin: 0 auto;">
		<br>
		<h3 align="center">Modify Information</h3>
		<form id="fo" action="modify" method="post">
	<table class="table">
		<tr>
			<th>ID</th> 
			<td>
				<input type="text" readonly value="${memberInfo.id }" name="id">
			</td>
		</tr>
		<tr>
			<th>Password</th> 
		...
		<tr>
			<td colspan="2" align="right">
				<button type="button" onclick="register()" class="btn btn-success" >Update</button>
			</td>
		</tr>
	</table>
	</form>
